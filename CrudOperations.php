...
class CrudOperations
{
    ...
    {
        if ($editId == "") {
            $query = "INSERT INTO crud_application SET name='$name',email='$email',contact='$contact',country='$country',state='$state',course='$course',city='$city',cval='$countryVal',stateVal='$stateVal',cityVal='$cityVal'";
        }else{
            $query = "UPDATE crud_application SET name='$name',email='$email',contact='$contact',country='$country',state='$state',city='$city' ,course='$course',cval='$countryVal',stateVal='$stateVal',cityVal='$cityVal' WHERE id='$editId' ";
        }
